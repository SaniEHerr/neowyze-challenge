    ...
    <div className="max-w-[1420px] mx-auto py-7">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {skeleton.map((index: any) => (
          <div
            key={index}
            className="bg-zinc-700 bg-opacity-60 backdrop-filter backdrop-blur-sm p-4 w-[236.79px] h-[408.42px] rounded-lg flex flex-col justify-between gap-3 animate-pulse duration-300"
          >
