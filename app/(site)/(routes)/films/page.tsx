  ...
  return (
    <div className="max-w-[1420px] mx-auto py-7">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {films.map((film: any) => (
          <Link href={`/films/${film.filmId}`} key={film.title} className="bg-zinc-700 bg-opacity-60 backdrop-filter backdrop-blur-sm p-4 rounded-lg flex flex-col justify-between gap-2">
